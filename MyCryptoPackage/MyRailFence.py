__mydoc__ = """
----------------------------------------------------------------------------
MyRailFence.py, Ennaayattulla
Tested with PyCharm Community Edition 2019.3 x64, python 3.7

MyRailFence specifications:
------------------------------

encrypt(rows, plaintext_utf8) where:
- rows: Number of rows to diagonalise plaintext
- plaintext_utf8: plaintext in UTF8 format
- return: ciphertext in UTF8 format

decrypt(key, ciphertext_utf8) where:
- rows: Number of rows to  reverse diagonalise plaintext
